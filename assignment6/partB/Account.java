...
public class Account {
    ...
    public double debitTransaction(double debitAmount) { return CurBalance -= debitAmount; }

    public double creditTransaction(double creditAmount) { return CurBalance += creditAmount; }
